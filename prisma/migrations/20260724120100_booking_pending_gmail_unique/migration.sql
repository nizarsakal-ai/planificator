-- C-BOOK-001 — Unique (companyId, gmailMessageId) UNIQUEMENT si aucun doublon.
...
BEGIN
  ...
  IF dup_count > 0 THEN
    ...
    RAISE EXCEPTION
      'C-BOOK-001: % groupe(s) de doublons pending_accommodations. Aucune suppression automatique. Consolider manuellement puis relancer. Diagnostic: %',
      dup_count,
